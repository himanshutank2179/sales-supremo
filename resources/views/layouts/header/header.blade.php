    ...
    <div class="navbar-header"> 
        ...
        <div class="top-left-part">
            <a class="logo" href="index.html">
                <b>
                    <img src="{{ url('plugins/images/eliteadmin-logo.png') }}" alt="home" class="dark-logo" />                  

                    <img src="{{ url('plugins/images/eliteadmin-logo-dark.png') }}" alt="home" class="light-logo" />
                </b>
                <span class="hidden-xs">
                    <!--This is dark logo text-->
                    <img src="{{ url('plugins/images/eliteadmin-text.png') }}" alt="home" class="dark-logo" />
                    <!--This is light logo text-->
                    <img src="{{ url('plugins/images/eliteadmin-text-dark.png') }}" alt="home" class="light-logo" />
                </span>
            </a>
        </div>
        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <div class="message-center">
                        <a href="#">
                            ...
                            <a href="#">
                                ...
                                <a href="#">
                                    <div class="user-img"> 
                                        <img src="{{ url('plugins/images/users/pawandeep.jpg') }}" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> 
                                    </div>
                                    <div class="mail-contnet">
                                        <h5>Pavan kumar</h5> 
            ...
            <li class="mega-dropdown"> 
                <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#">
                    <span class="hidden-xs">Mega</span> <i class="icon-options-vertical"></i>
                </a>
                <ul class="dropdown-menu mega-dropdown-menu animated bounceInDown">
                    ...
                    <li class="col-sm-12 m-t-40 demo-box">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="white-box text-center bg-danger"><a href="https://themeforest.net/item/elite-admin-responsive-web-app-kit-/16750820" target="_blank" class="text-white"><i class="linea-icon linea-ecommerce fa-fw" data-icon="d"></i><br/>Buy Now</a>
                                </div>
                            </div>
                        </div>
                    </li>
